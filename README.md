...
## v31.8
- Исправлена live-лента: стабильная бегущая строка без разъезда шапки.
- Добавлен переключатель тем слева в шапке.
- Темы: Classic, Dark, Light, Vitality, Falcons, Fnatic, 9z, Spirit, VP, Cloud9, NAVI, FaZe, PARIVISION.
