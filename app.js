(function(){
  ...
  const CURRENCY = '₽LC';
  const PRICE_VERSION = 'market-rub-v27';
  ...
  async function boot(){
    try{
      ...
      // v27: страницы не ждут внешний API. Сначала мгновенно рисуем встроенный каталог,
  ...
  function updateHeroShowcase(){
    // v27: главная витрина использует только жёстко заданные реальные URL из index.html.
